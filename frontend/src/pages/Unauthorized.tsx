		...
		<>
			...
			<div className="container flex flex-col items-center justify-center h-screen">
				...
				<div className="w-full flex justify-evenly">
					...
					<Link
						to="/login"
						className="btn text-lg rounded-none hover:text-white hover:border-white border-custom-accent hover:bg-custom-accent bg-custom-bg-dark text-custom-accent mt-10 scale-150"
					>
						LOGIN <FaArrowRight />
					</Link>
				</div>
